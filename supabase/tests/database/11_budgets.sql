...
-- semantik boundary-nya identik, tetapi 1 Okt 2026 sudah masuk masa depan dan
-- trigger V2 `enforce_transaction_no_future` menolak occurred_at masa depan.
-- Semua fixture di file ini wajib masa lalu — lihat `13_transfer.sql`.
-- ---------------------------------------------------------------------------
...
insert into public.budgets (id, user_id, category_id, month, amount_limit) values
  ...
  ('bd000000-0000-4000-a000-000000000005', 'a11ce000-0000-4000-a000-000000000001',
   'cb000000-0000-4000-a000-000000000001', '2025-10-01', 1000000),
...
insert into public.transactions
  ...
  ('bc000000-0000-4000-a000-000000000003', 'a11ce000-0000-4000-a000-000000000001',
   'ca000000-0000-4000-a000-000000000001', 'cb000000-0000-4000-a000-000000000001',
   'expense', 700000, '2025-10-01T00:30:00+07:00', 'be000000-0000-4000-a000-000000000003', null),
