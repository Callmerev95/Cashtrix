...
Ticket tanpa blocker yang belum selesai: **#10 (T9 — Data ownership)**, **#9 (T8 — Profile + kategori kustom)**, dan **#11 (T10 — Observability)** — semua dapat dikerjakan paralel sekarang.

Selesai (di-merge ke `main`, squash): T1 — #3 via PR #13 · T2 — #2 via PR #14 · T3 — #4 via PR #15 · T4 — #5 via PR #16 (squash `cb3b9df`) · T5 — #6 via PR #17 (squash `492b8f2`) · T6 — #7 via PR #18 (squash `c688a41`) · T7 — #8 via PR #19 (squash `160f71c`).
