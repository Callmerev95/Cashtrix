...
- Dedup alert: insert ke `budget_alerts` pakai `ON CONFLICT DO NOTHING`; edit/hapus transaksi yang menurunkan % tidak menghapus alert yang sudah fired.
